...
const credential = JSON.parse(Buffer.from(process.env.GOOGLE_SERVICE_KEY).toString());
...
export const BIGQUERY_SESSION_TABLE_ID = process.env.BIGQUER_SESSION_TABLE_ID;
